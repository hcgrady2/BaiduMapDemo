...
import com.hc.mapdemo.BaiduLBSDemo.indoorview.BaseStripAdapter;
import com.hc.mapdemo.BaiduLBSDemo.indoorview.StripListView;
import com.hc.mapdemo.BaiduLBSDemo.overlayutil.IndoorRouteOverlay;
...
//        mFloorListAdapter.setSelectedPostion();
    ...
    private void EnableIndoorMap() {
        ...
        Toast.makeText(IndoorMapDemo.this, "室内图已打开", Toast.LENGTH_SHORT).show();
    }
    ...
    private void DisableIndoorMap() {
        ...
        Toast.makeText(IndoorMapDemo.this, "室内图已关闭", Toast.LENGTH_SHORT).show();
    }
}
