package com.hc.mapdemo.Location.demo;
 ...
 * 运动场景示例demo
 */
public class TransportSceneActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSceneDescribeTV.setText("运动场景 高精度连续定位，适用于用户内外切换的场景，卫星定位和网络定位相互切换，" +
        ...
        /*运动场景 高精度连续定位，适用于有户内外切换的场景，卫星定位和网络定位相互切换，卫星定位成功之后网络定位不再返回，
