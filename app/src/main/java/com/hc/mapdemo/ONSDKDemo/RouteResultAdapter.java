...
public class RouteResultAdapter extends RecyclerView.Adapter<RouteResultAdapter.BNHolder> {
    ...
    @Override
    public RouteResultAdapter.BNHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new BNHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_route_detail,
                parent, false));
    }

    @Override
    public void onBindViewHolder(RouteResultAdapter.BNHolder holder, int position) {
